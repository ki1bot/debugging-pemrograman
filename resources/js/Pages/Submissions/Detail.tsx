import CodeEditor from "@/Components/EditorKode";
...
export default function SubmissionShow({
    ...
    return (
        ...
        >
            <Head
                title={`Hasil ${submission.challenge.title}`}
            />

            <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
                {!canViewSolution && (
                    <section className="nb-card mb-8 bg-[#fff1a8] p-6">
                        <span className="nb-badge bg-white">
                            Pembahasan Dikunci
                        </span>

                        <h2 className="mt-4 text-2xl font-black">
                            Selesaikan tantangan untuk
                            membuka solusi
                        </h2>

                        <p className="mt-3 max-w-3xl font-semibold leading-7 text-neutral-700">
                            Skor dan jawaban Anda tetap
                            dapat dilihat. Solusi utama,
                            alternatif solusi, lokasi baris
                            bug, dan pembahasan lengkap akan
                            dibuka setelah tantangan berhasil
                            diselesaikan.
                        </p>
                    </section>
                )}
                ...
                <section className="mt-10 grid gap-8 xl:grid-cols-2">
                    ...
                    {canViewSolution ? (
                        ...
                        <article className="nb-card flex min-h-[480px] items-center justify-center bg-[#d9d9d9] p-6 text-center">
                            <div>
                                <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full border-[3px] border-black bg-white text-4xl shadow-[4px_4px_0_#111]">
                                    🔒
                                </div>
                                ...
                                <p className="mx-auto mt-3 max-w-sm font-semibold leading-7 text-neutral-700">
                                    Perbaiki jawaban sampai
                                    tantangan berstatus selesai
                                    untuk melihat kode solusi.
                                </p>
                            </div>
                        </article>
                    )}
                ...
                <section className="mt-8 grid gap-8 lg:grid-cols-2">
                    ...
                    {canViewSolution ? (
                        ...
                        <article className="nb-card flex items-center justify-center bg-[#d9d9d9] p-6 text-center">
                            <div>
                                <h2 className="text-2xl font-black">
                                    Pembahasan belum tersedia
                                </h2>

                                <p className="mt-3 max-w-md font-semibold leading-7 text-neutral-700">
                                    Gunakan hasil skor pada
                                    bagian atas sebagai panduan,
                                    lalu kerjakan kembali
                                    tantangan tersebut.
                                </p>
                            </div>
                        </article>
