            ...
            <section className="border-b-[3px] border-black bg-[#9ed8ff]">
                <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
                    <p className="text-sm font-black uppercase tracking-[0.18em]">
                        Daftar Latihan Debugging
                    </p>

                    <h1 className="page-title mt-4">
                        Pilih tantangan yang ingin kamu selesaikan.
                    </h1>

                    <p className="mt-6 max-w-3xl text-lg font-semibold leading-8">
                        Cari berdasarkan topik, bahasa, atau tingkat kesulitan.
                        Setelah memilih tantangan, kamu dapat memperbaiki dan
                        menguji kode melalui sandbox sebelum mengirim jawaban.
                    </p>
                </div>
            </section>
