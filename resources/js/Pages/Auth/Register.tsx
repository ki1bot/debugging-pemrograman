...
export default function Register() {
    ...
    return (
        <GuestLayout>
            ...
            <span className="nb-badge bg-[#9ef0b8]">Daftar Akun</span>

            <h1 className="mt-5 text-4xl font-black tracking-[-0.06em]">
                Buat akun untuk mulai berlatih
            </h1>

            <p className="mt-3 font-semibold leading-7 text-neutral-700">
                Akun Debugging Pemrograman digunakan untuk menyimpan poin,
                perkembangan latihan, riwayat jawaban, dan posisi peringkatmu.
            </p>
