    ...
    return (
        <GuestLayout>
            ...
            <p className="mt-4 font-semibold leading-7 text-neutral-700">
                Kami telah mengirimkan tautan verifikasi ke alamat emailmu.
                Gunakan tombol di bawah apabila email tersebut belum diterima.
            </p>
            ...
            <form onSubmit={submit} className="mt-7">
                <PrimaryButton className="w-full py-4" disabled={processing}>
                    {processing ? "Sedang Mengirim..." : "Kirim Ulang Tautan"}
                </PrimaryButton>
            </form>
