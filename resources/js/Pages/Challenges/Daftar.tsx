            ...
            <section className="border-b-[3px] border-black bg-[#9ed8ff]">
                <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
                    ...
                    <h1 className="page-title mt-4">
                        Pilih bug yang akan diburu.
                    </h1>

                    <p className="mt-6 max-w-3xl text-lg font-semibold leading-8">
                        Filter berdasarkan bahasa dan tingkat kesulitan. Seluruh
                        tantangan diperiksa tanpa menjalankan kode pengguna di
                        server.
                    </p>
                </div>
            </section>
                ...
                >
                    <div>
                        ...
                        <input
                            ...
                            className="nb-input"
                            placeholder="Contoh: array, JOIN, session"
                        />
                    </div>
                ...
                {challenges.data.length > 0 ? (
                    ...
                    <div className="mt-8">
                        <EmptyState
                            ...
                            description="Ubah kata pencarian atau hapus filter yang terlalu sempit."
                        />
                    </div>
                )}
            </div>
